...
const TornPaperFilter = ({ id, scale = 10 }: { id: string, scale?: number }) => (
  ...
  /* ─── 1. Couple → Events ────────────────────────────────────────
   Deep Green (#2D5A3D) to Dark Sage (#233a2c).
   Torn edge of Couple's base blending into Events top.
─────────────────────────────────────────────────────────────── */
function DividerCoupleEvents() {
  return (
    <div className="sd reveal-up" style={{ background: "#233a2c", marginTop: "-2px" }}>
  ...
  return (
    <div className="sd reveal-up" style={{ background: "var(--cream)", marginTop: "-2px" }}>
      <svg className="sd-svg" viewBox="0 0 1440 100" preserveAspectRatio="none" style={{ minHeight: "100px" }}>
        ...
        <path d="M-50,-50 L1490,-50 L1490,40 C1100,80 800,0 300,50 C100,70 -50,30 -50,30 Z" fill="#233a2c" filter="url(#events-torn-user)"></path>
      </svg>
    </div>
  );
}
...
/* ─── 5. Wishes → Gift ───────────────────────────────────────────
   Dark Green (#233a2c) to Cream. Torn paper of Dark Green over Cream.
─────────────────────────────────────────────────────────────── */
  ...
  return (
    <div className="sd reveal-up" style={{ background: "var(--cream)", marginTop: "-2px" }}>
      <svg className="sd-svg" viewBox="0 0 1440 120" preserveAspectRatio="none" style={{ minHeight: "120px" }}>
        ...
        <path d="M-50,-50 L1490,-50 L1490,60 C1200,20 600,120 -50,40 Z" fill="#233a2c" filter="url(#wishes-torn)" />
